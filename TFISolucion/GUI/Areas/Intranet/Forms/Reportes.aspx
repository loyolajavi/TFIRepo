            ...
            <thead>
                <tr>
                    <td colspan="2" class="col-md-8">
                        <h4><asp:Label ID="Label1" runat="server" Text="<%$Resources:Global, Reportes %>"></asp:Label></h4>
                    </td>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td class="vertical"> <asp:Label ID="Label3" runat="server" Text="<%$Resources:Global, ReportePedidosPorFecha %>"></asp:Label>
                    </td>
                    <td style="width: 0%; text-align: center;">
                        <a href="#">
                            <img src="/Content/Images/Iconos/pdf.png" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-top:10px">
                    <div class="form-group">
                        <label for="filtro" style="font-weight:200; color:#333333; font-size:12PX;"><asp:Label ID="Label5" runat="server" Text="<%$Resources:Global, Usuario %>"></asp:Label></label>
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        <button type="button" class="btn" style="width: 200px; background-color: black; color: #fff;" data-dismiss="modal"><asp:Label ID="Label6" runat="server" Text="<%$Resources:Global, Generar %>"></asp:Label></button>
                    </div>
                </div>
            </div>
        </div>
