...
<asp:Content ID="Content2" ContentPlaceHolderID="MiContenido" runat="server">
    ...
    <div class="container paddingPaginas">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">
                    <asp:Label ID="Label1" runat="server" Text="<%$Resources:Global, QuienesSomos %>"></asp:Label> <small>   <asp:Label ID="Label2" runat="server" Text="<%$Resources:Global, GestionContenidos %>"></asp:Label></small>
                </h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3><asp:Label ID="Label3" runat="server" Text="<%$Resources:Global, NombreEmpresa %>"></asp:Label></h3>
                ...
                <h3><asp:Label ID="Label4" runat="server" Text="<%$Resources:Global, TelefonoEmpresa %>"></asp:Label></h3>
                ...
                <h3><asp:Label ID="Label5" runat="server" Text="<%$Resources:Global, MailEmpresa %>"></asp:Label></h3>
                <label for="MailEmpresa"></label>
                <input id="MailEmpresa" class="form-control" clientidmode="static" name="MailEmpresa" runat="server" />

                <hr />

                <h3><asp:Label ID="Label6" runat="server" Text="<%$Resources:Global, QuienesSomos %>"></asp:Label></h3>
                ...
                <h3><asp:Label ID="Label7" runat="server" Text="<%$Resources:Global, Mision %>"></asp:Label></h3>
                ...
                <h3><asp:Label ID="Label8" runat="server" Text="<%$Resources:Global, Vision %>"></asp:Label></h3>
