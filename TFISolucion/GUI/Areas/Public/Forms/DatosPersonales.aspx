                    ...
                    <div class="modal-body">
                        <form role="form">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="calleenvio" runat="server"> </asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="numeroenvio">Numero</label>
                                <input type="number" class="form-control" id="numeroenvio" placeholder="Ingrese el numero de la direccion" runat="server" />
                            </div>
                            <div class="form-group">
                                <label for="pisoenvio">Piso</label>
                                <input type="text" class="form-control" id="pisoenvio" runat="server" placeholder="Ingrese el piso" />
                            </div>
                            <div class="form-group">
                                <label for="departamentoenvio">Departamento</label>
                                <input type="text" class="form-control" id="departamentoenvio" runat="server" placeholder="Ingrese el departamento" />
                            </div>

                            <div class="form-group">
                                <label for="localidadenvio">Localidad</label>
                                <input type="text" class="form-control" id="localidadenvio" runat="server" placeholder="Ingrese la localidad" />
                            </div>
                            <div class="form-group">
                                <label for="ddlProvinciaEnvio">Provincia</label>
                                <asp:DropDownList ID="ddlProvinciaEnvio" runat="server"></asp:DropDownList>
                            </div>
                            <asp:Button ID="btnGrabarDireccionDeEnvio" runat="server" ClientIDMode="static" Text="Guardar" CssClass="btn btn-primary btn-block" />
                            <%--<button type="button" id="btnGrabarDireccionEnvio" onserverclick="btnGrabarDireccionEnvio_Click" runat="server" class="btn btn-primary btn-block">Aceptar</button>--%>
                        </form>
                    </div>
                </div>
            </div>
